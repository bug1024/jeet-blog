...
## 常用命令
 通常包括`git clone` `git checkcout` `git pull` `git push` `git merge`，
...
* 完善git配置，可[参考](https://sandwind.gitbooks.io/git-pro-cn/content/git-custom/config.html)，[本人配置文件](http://bug1024.com/img/gitconfig)
